...
add wave -noupdate -group user_write_load -radix hexadecimal /sdram_mcb_tb/wr_load
add wave -noupdate -group user_write_load -radix hexadecimal /sdram_mcb_tb/wr_addr
add wave -noupdate -group user_write_load -radix hexadecimal /sdram_mcb_tb/wr_length
add wave -noupdate -group user_stage_write -radix binary /sdram_mcb_tb/wr_rdy
add wave -noupdate -group user_stage_write /sdram_mcb_tb/wr_req
add wave -noupdate -group user_stage_write -radix hexadecimal /sdram_mcb_tb/din
add wave -noupdate -group mcb_write_series /sdram_mcb_tb/u0/wr_load_d2
add wave -noupdate -group mcb_write_series /sdram_mcb_tb/u0/wr_load_d3
add wave -noupdate -group mcb_write_series /sdram_mcb_tb/u0/wr_load_pulse
add wave -noupdate -group mcb_write_series -color Gold /sdram_mcb_tb/u0/wr_pending
add wave -noupdate -group mcb_write_series -radix unsigned /sdram_mcb_tb/u0/wr_fifo_rd_count
add wave -noupdate -group mcb_write_series -radix hexadecimal /sdram_mcb_tb/u0/wr_fifo_dout
add wave -noupdate -group mcb_write_series -radix binary /sdram_mcb_tb/u0/wr_req
add wave -noupdate -group mcb_write_series -radix hexadecimal /sdram_mcb_tb/u0/din
add wave -noupdate -group mcb_write_series /sdram_mcb_tb/u0/wr_fifo_ren
add wave -noupdate -group mcb_write_series -format Analog-Step -height 74 -max 1024.0 -radix unsigned /sdram_mcb_tb/u0/wr_fifo_wr_count
add wave -noupdate -group mcb_write_series /sdram_mcb_tb/u0/wr_done
...
add wave -noupdate -group user_read_load /sdram_mcb_tb/rd_load
add wave -noupdate -group user_read_load -radix hexadecimal /sdram_mcb_tb/rd_addr
add wave -noupdate -group user_read_load -radix hexadecimal /sdram_mcb_tb/rd_length
add wave -noupdate -color Gold /sdram_mcb_tb/u0/rd_pending
add wave -noupdate -group user_stage_read /sdram_mcb_tb/rd_req
add wave -noupdate -group user_stage_read -radix unsigned /sdram_mcb_tb/u0/rd_fifo_wr_count
add wave -noupdate -group user_stage_read /sdram_mcb_tb/u0/rd_fifo_empty
add wave -noupdate -group user_stage_read /sdram_mcb_tb/u0/rd_req
add wave -noupdate -group user_stage_read /sdram_mcb_tb/dout
add wave -noupdate -group user_stage_read /sdram_mcb_tb/rd_done
...
add wave -noupdate /sdram_mcb_tb/u0/rd_fifo_full
add wave -noupdate -expand -group sdram_model -radix unsigned /sdram_mcb_tb/u1/cnt
add wave -noupdate -expand -group sdram_model -radix unsigned /sdram_mcb_tb/u1/state
add wave -noupdate -expand -group sdram_model /sdram_mcb_tb/u1/value
add wave -noupdate -expand -group sdram_model /sdram_mcb_tb/u1/wen
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {841319211 ps} 0} {{Cursor 2} {29194649 ps} 0}
...
update
WaveRestoreZoom {29117158 ps} {29332842 ps}
