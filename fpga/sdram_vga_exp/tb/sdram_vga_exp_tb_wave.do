...
add wave -noupdate -expand -group mbc_read_sdram /sdram_vga_exp_tb/u0/mem_arbitor/sdram_mcb/sdram_rd_fifo/empty
add wave -noupdate -expand -group mbc_read_sdram /sdram_vga_exp_tb/u0/mem_arbitor/sdram_mcb/sdram_rd_fifo/full
add wave -noupdate -expand -group mbc_read_sdram -radix hexadecimal /sdram_vga_exp_tb/u0/mem_arbitor/sdram_mcb/rd_fifo_din
add wave -noupdate -group mem_arbitor /sdram_vga_exp_tb/u1/cmd
add wave -noupdate -group mem_arbitor -radix unsigned /sdram_vga_exp_tb/u1/cnt
add wave -noupdate -group mem_arbitor -radix unsigned /sdram_vga_exp_tb/u1/state
add wave -noupdate -group mem_arbitor /sdram_vga_exp_tb/u1/value
...
WaveRestoreCursors {{Cursor 1} {3491387 ps} 0}
...
update
WaveRestoreZoom {3015685 ps} {3907851 ps}
