...
add wave -noupdate -expand -group VGA /sdram_vga_exp_tb/u0/vga_hsync
add wave -noupdate -expand -group VGA /sdram_vga_exp_tb/u0/vga_vsync
add wave -noupdate -expand -group VGA -radix unsigned /sdram_vga_exp_tb/u0/vga_red
add wave -noupdate -expand -group VGA -radix unsigned /sdram_vga_exp_tb/u0/vga_green
add wave -noupdate -expand -group VGA -radix unsigned /sdram_vga_exp_tb/u0/vga_blue
...
add wave -noupdate -group mbc_read_sdram -format Analog-Step -height 74 -max 1024.0 -radix unsigned /sdram_vga_exp_tb/u0/mem_arbitor/sdram_mcb/rd_fifo_rd_count
add wave -noupdate -group mbc_read_sdram -radix binary /sdram_vga_exp_tb/u0/mem_arbitor/sdram_mcb/rd_fifo_wen
add wave -noupdate -group mbc_read_sdram -radix unsigned /sdram_vga_exp_tb/u0/mem_arbitor/sdram_mcb/rd_fifo_wr_count
add wave -noupdate -group mbc_read_sdram -radix unsigned /sdram_vga_exp_tb/u0/mem_arbitor/sdram_mcb/rd_fifo_underflow
add wave -noupdate -group mbc_read_sdram -radix hexadecimal /sdram_vga_exp_tb/u0/mem_arbitor/sdram_mcb/rd_addr_r
add wave -noupdate -group mbc_read_sdram -radix binary /sdram_vga_exp_tb/u0/mem_arbitor/sdram_mcb/rd_req
add wave -noupdate -group mbc_read_sdram /sdram_vga_exp_tb/u0/mem_arbitor/mem_rd_done
add wave -noupdate -group mbc_read_sdram -radix hexadecimal /sdram_vga_exp_tb/u0/mem_arbitor/sdram_mcb/rd_fifo_din
...
WaveRestoreCursors {{Cursor 1} {739756667 ps} 0} {{Cursor 2} {1325143334 ps} 0}
...
update
WaveRestoreZoom {739628482 ps} {739884852 ps}
